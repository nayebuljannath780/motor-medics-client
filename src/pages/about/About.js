...
const About = () => {
    return (
        <div className="hero mt-16 mb-28">
            <div className="hero-content flex-col lg:flex-row">
                ...
                <div className='w-1/2'>
                    ...
                    <p className="py-6">With over 10 years of experience in motorbike service, we take pride in providing the best service possible to our clients. Our team of skilled technicians is committed to ensuring that your motorbike runs smoothly and efficiently, so you can enjoy a safe and comfortable ride. Whether you need routine maintenance, repairs, or customizations, we've got you covered. Trust us to keep your motorbike in top condition.</p>
